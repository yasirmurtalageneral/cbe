...
if($_SESSION['username']&&$password){
  ...
  if($numrows !=0)
  {
    ...
    if($_SESSION['username']==$dbuser)
    {
      ...
      $msg="<p class='alert alert-danger text-center animated shake'>Incorrect username Address</p>";
                                ...
                                <div class="welcome-text col-lg-12 offset-sm-7">
                                              ...
                                              <div class=" col-lg-10 offset-sm-1  mt-1">
                                                <div class="card" style="margin-top: -120px;">
                                                    <div class="card-header"><h5><span class="fa fa-user"></span> User Login</h5></div>
                                                    <div class="card-body">
                                                      <?php echo $msg; ?>
...
<footer class="main-footer fixed-bottom text-center" >
    <div class="container" style="margin-top: -10px;">
      ...
      <strong>Copyright &copy; 2019 Powered by <a href="https://adminlte.io">TeamCODED Edusoft Limited</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
